...
(function ($) {
    ...
    $.fn.percentageLoader = function (params) {
        var settings, canvas, percentageText, valueText, items, i, item, selectors, s, ctx, progress,
            ...
            applyAngle, drawLoader, clipValue, outerDiv, progressTxt;
        ...
        for (i  = 0; i < items.length; i += 1) {
            item = items[i];
            selectors = [							//This is something to avoid user selection of text
                '-webkit-user-select',
                '-khtml-user-select',
                '-moz-user-select',
                '-o-user-select',
        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                percentageText.innerHTML = ((progressTxt*100)/100).toFixed(1) +('&#0176'+'C').fontsize(4.5);	//edited to add °C


                /* Calculate font and placement of small 'value' text */
                smallSize = cX / 5.5;
                valueText.style.color = '#993366';
        ...
        */
        ...
        setValue = function (val) {
            value = settings.sensor;											//SrS-> this set the value 
        ...
        //progress = (settings.temp/settings.maxtemp);							//SrS-> This value set the progress bar status
        clipValue();
